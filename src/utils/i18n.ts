...
const messages: Record<string, Messages> = {
    ...
    'ja': {
        ...
        majorFound: '{0} 件のメジャーバージョン更新が見つかりました。破壊的変更が含まれる可能性があります：',
    ...
    'ko': {
        ...
        majorFound: '{0}개의 주요 버전 업데이트가 발견되었습니다. 호환성을 깨뜨리는 변경이 포함될 수 있습니다:',
    ...
    'fr': {
        ...
        majorFound: '{0} mise(s) à jour majeure(s) trouvée(s) pouvant inclure des changements incompatibles :',
    ...
    'de': {
        ...
        majorFound: '{0} Hauptversions-Update(s) gefunden, die inkompatible Änderungen enthalten können:',
    ...
    'it': {
        ...
        majorFound: 'Trovati {0} aggiornamenti di versione importante che possono includere modifiche incompatibili:',
    ...
    'es': {
        ...
        majorFound: 'Se encontraron {0} actualizaciones de versión importante que pueden incluir cambios incompatibles:',
    ...
    'ru': {
        ...
        majorFound: 'Найдено {0} мажорных обновлений, которые могут содержать несовместимые изменения:',
